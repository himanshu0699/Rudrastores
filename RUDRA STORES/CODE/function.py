...
def part_stock():
    ...
    print()
    cursor.execute("SELECT itemcode,ItemName, Stockleft FROM inventory WHERE itemname = '" + C1 + "'")
    data = cursor.fetchall()
    r = cursor.rowcount
    if r > 0:
        return True,data,r
...
def additem():
    ...
    M1 = input_ain("ITEM NAME: ").upper()
    M2 = input_alpha("CATEGORY: ").upper()
    M3 = input_int("PRICE: ")
...
#USING ITEMNAME
def deleteitem_name():
    H1 = input_alpha("ENTER ITEM NAME : ").upper()
...
def acceptorders(U1,U2):
    ...
    if J7 == 1:
        ...
        headers = ["Number", "Item Name", "Price","EXPIRY DATE"]
        ...
        if r > 0 :
            ...
            return "SELECT APPROPRIATE OPTION ! ! !"
...
def l9():
    ...
    print(line)
    print()
#6.This function is used to print for better view
def l1():
    line = ">" * 7
    print()
    print(line)
